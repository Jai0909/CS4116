...
while ($column = mysqli_fetch_field($result)) {
    $columns[] = $column->name;
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <a href="viewOtherProfile.php?user_id=<?php echo $row['USER_ID']; ?>" class="btn btn-default">View Profile</a>
</div><?php
                    }
                    }
                } 
            ...
            if ($result1) {
                if (mysqli_num_rows($result1)>0) {
                    while ($row1 = mysqli_fetch_assoc($result1)) {
                       ...
                       <a href="viewOtherProfileOrg.php?user_id=<?php echo $row1['ORG_ID']; ?>" class="btn btn-default">View Profile</a>
</div><?php
                    }
                }
                } 
...
while ($column = mysqli_fetch_field($result)) {
    $columns[] = $column->name;
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <a href="viewJob.php?user_id=<?php echo $row['JOB_ID']; ?>" class="btn btn-default">View Job</a>
</div><?php
                    }
                } 
        }
